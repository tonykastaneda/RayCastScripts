...
# @raycast.mode silent
# @raycast.packageName atom.
#
# Optional parameters:
# @raycast.icon images/atom.png
#
# Documentation:
# @raycast.description Opens current topmost directory in Atom
# @raycast.author Tony
# @raycast.authorURL https://github.com/tonykastaneda
...
do shell script "open -n -b \"com.github.atom\" --args " & quoted form of POSIX path of (p as alias)
